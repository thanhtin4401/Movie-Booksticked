...
export default function FooterTheme() {
  ...
  return <div style={{backgroundColor:"#151515"}}>
    <div style={{borderBottom:"1px solid #666"}}
     className="grid grid-cols-4 gap-10 container mx-auto px-10 py-10 ">
        ...
        <div className="col">
            ...
            <div className="flex gap-10 flex-wrap my-3">
                {renderTheater()}
            </div>
        </div>
    ...
    <h1 className="text-white font-bold text-center py-5">Designed by TRAN DINH DANH</h1>
  </div>
}
