...
export default function TabMovie() {
  ...
  const renderTenCumRap = (cumRap) => {
    return (
      <div className="text-left">
        <p className="text-green-600 font-bold truncate text-base">
          {cumRap.tenCumRap}
        </p>
  ...
  return (
    <div id="cumRap" className="container theaterTab mb:overflow-scroll sm:overflow-scroll lg:mx-20 lg:p-10 mb:w-full  lg:w-10/12">
